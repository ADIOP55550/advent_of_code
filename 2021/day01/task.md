...
   [\$year=]{.title-event-wrap}[2021](/2021)[;]{.title-event-wrap} {#year2021 .title-event}
==================================================================
...
::: {.sponsor}
[Ramp](https://boards.greenhouse.io/ramp?gh_src=2783e2862us) - Have you
ever sped up a real-world job 5x using software? Ramp does that for
companies every day with financial automation. We\'re hiring ambitious
engineers (Python, Elixir, Typescript) - join us if you like fast
growth!
:::
:::
:::
...
[Twitter](https://twitter.com/intent/tweet?text=I%27ve+completed+Part+One+of+%22Sonar+Sweep%22+%2D+Day+1+%2D+Advent+of+Code+2021&url=https%3A%2F%2Fadventofcode%2Ecom%2F2021%2Fday%2F1&related=ericwastl&hashtags=AdventOfCode)
